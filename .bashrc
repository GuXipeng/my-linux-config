...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;00m\]\u\[\033[01;32m\]@\[\033[01;34m\]\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
export OPENJDK_HOME=/usr/lib/jvm/java-7-openjdk-amd64

export JRE_OPENJDK_HOME=/usr/lib/jvm/java-7-openjdk-amd64/jre

export JAVA_HOME=/opt/jdk1.6.0_43 #:$OPENJDK_HOME

export JRE_HOME=/opt/jdk1.6.0_43/jre #:$JRE_OPENJDK_HOME

#export JAVA_HOME=/opt/jdk1.7.0_71/:$OPENJDK_HOME

#export JRE_HOME=/opt/jdk1.7.0_71/jre:$JRE_OPENJDK_HOME
